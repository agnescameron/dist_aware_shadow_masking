...
to_test = {'ISTD': '/Users/agnes/Documents/WORK/cici_wu/test_code/distraction_aware/Datasets/ISTD'}
    ...
    with torch.no_grad():
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                check_mkdir(
                    os.path.join('Output/ISTD', '%s_%s_prediction_%s' % (exp_name, name, args['snapshot'])))
